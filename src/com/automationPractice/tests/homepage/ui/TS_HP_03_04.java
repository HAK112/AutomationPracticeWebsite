...
public class TS_HP_03_04 extends TestClass {

	public TS_HP_03_04(WebDriver driver, String baseURL) throws IOException {
	...
	public void test() throws IOException {
		...
		getExcelFileData("resource//testData//testData.xlsx", "Dashboard", "TS_HP_03_04");
		...
		if(!verifyResultEquals(homePage.getSummerDressesSubMenuItemTitle(), getExpectedResult())) {
			System.out.println("Title Case Failed. Actual Result and Expected Result Differs");
			writeData("Fail");
			return;
		}
